...
export default function AvatarGallery2() {
  const galleryRef = useGalleryTouchEvents();
  const galleryItems = [
    { id: 1, linkid: "1250d8c4-9f4d-4169-8c52-96b65aad07e8/avatar-1.png?avatarName=Love%20in%20Seoul&creatorName=Akira%20Yuusha&style=manhwa" },
    { id: 2, linkid: "3c2fa315-f6fe-46fe-940e-676af26f0eea/avatar-2.png?avatarName=Heaven%20Sword&creatorName=Akira%20Yuusha&style=manhua" },
    { id: 3, linkid: "1250d8c4-9f4d-4169-8c52-96b65aad07e8/avatar-3.png?avatarName=Love%20in%20Seoul&creatorName=Akira%20Yuusha&style=manhwa" },
    { id: 4, linkid: "1250d8c4-9f4d-4169-8c52-96b65aad07e8/avatar-4.png?avatarName=Love%20in%20Seoul&creatorName=Akira%20Yuusha&style=manhwa" },
    { id: 5, linkid: "3c2fa315-f6fe-46fe-940e-676af26f0eea/avatar-5.png?avatarName=Heaven%20Sword&creatorName=Akira%20Yuusha&style=manhua" },
    { id: 6, linkid: "1250d8c4-9f4d-4169-8c52-96b65aad07e8/avatar-6.png?avatarName=Love%20in%20Seoul&creatorName=Akira%20Yuusha&style=manhwa" },
    { id: 7, linkid: "3c2fa315-f6fe-46fe-940e-676af26f0eea/avatar-7.png?avatarName=Heaven%20Sword&creatorName=Akira%20Yuusha&style=manhua" },
    { id: 8, linkid: "1250d8c4-9f4d-4169-8c52-96b65aad07e8/avatar-8.png?avatarName=Love%20in%20Seoul&creatorName=Akira%20Yuusha&style=manhwa" },
    { id: 9, linkid: "1250d8c4-9f4d-4169-8c52-96b65aad07e8/avatar-9.png?avatarName=Love%20in%20Seoul&creatorName=Akira%20Yuusha&style=manhwa" },
    { id: 10, linkid: "3c2fa315-f6fe-46fe-940e-676af26f0eea/avatar-10.png?avatarName=Heaven%20Sword&creatorName=Akira%20Yuusha&style=manhua" },
    { id: 11, linkid: "1250d8c4-9f4d-4169-8c52-96b65aad07e8/avatar-11.png?avatarName=Love%20in%20Seoul&creatorName=Akira%20Yuusha&style=manhwa" },
    { id: 12, linkid: "3c2fa315-f6fe-46fe-940e-676af26f0eea/avatar-12.png?avatarName=Heaven%20Sword&creatorName=Akira%20Yuusha&style=manhua" },
  ];
            ...
            >
              <div className="aspect-square overflow-hidden">
                <Image
                  ...
                  src={`/images/avatar/gallery-2/avatar-${item.id}.png`}
          ...
          <div className="col-span-2 md:col-span-1 row-span-2">
            <div className="group gallery-card h-full relative overflow-hidden rounded-xl shadow-lg transition-all duration-400 hover:shadow-2xl transform hover:-translate-y-1">
              <div className="aspect-[3/5] h-full w-full overflow-hidden">
                <Image
                  className="h-full w-full object-cover transition-transform duration-400 ease-in-out group-hover:scale-110"
                  src="/images/avatar/gallery-2/avatar-1.png"
                  alt="AI Avatar 1"
                  width={600}
                  height={1000}
                />
          ...
          <div className="col-span-1 row-span-1">
            <div className="group gallery-card h-full relative overflow-hidden rounded-xl shadow-lg transition-all duration-400 hover:shadow-2xl transform hover:-translate-y-1">
              <div className="aspect-square h-full w-full overflow-hidden">
                <Image
                  className="h-full w-full object-cover transition-transform duration-400 ease-in-out group-hover:scale-110"
                  src="/images/avatar/gallery-2/avatar-2.png"
                  alt="AI Avatar 2"
                  width={800}
                  height={800}
                />
          ...
          <div className="col-span-2 row-span-1">
            <div className="group gallery-card h-full relative overflow-hidden rounded-xl shadow-lg transition-all duration-400 hover:shadow-2xl transform hover:-translate-y-1">
              <div className="aspect-[16/9] h-full w-full overflow-hidden">
                <Image
                  className="h-full w-full object-cover transition-transform duration-400 ease-in-out group-hover:scale-110"
                  src="/images/avatar/gallery-2/avatar-3.png"
                  alt="AI Avatar 3"
                  width={1024}
                  height={576}
                />
          ...
          <div className="col-span-1 row-span-1">
            <div className="group gallery-card h-full relative overflow-hidden rounded-xl shadow-lg transition-all duration-400 hover:shadow-2xl transform hover:-translate-y-1">
              <div className="aspect-[3/4] h-full w-full overflow-hidden">
                <Image
                  className="h-full w-full object-cover transition-transform duration-400 ease-in-out group-hover:scale-110"
                  src="/images/avatar/gallery-2/avatar-4.png"
                  alt="AI Avatar 4"
                  width={768}
                  height={1024}
                />
          ...
          <div className="col-span-1 row-span-1">
            <div className="group gallery-card h-full relative overflow-hidden rounded-xl shadow-lg transition-all duration-400 hover:shadow-2xl transform hover:-translate-y-1">
              <div className="aspect-square h-full w-full overflow-hidden">
                <Image
                  className="h-full w-full object-cover transition-transform duration-400 ease-in-out group-hover:scale-110"
                  src="/images/avatar/gallery-2/avatar-5.png"
                  alt="AI Avatar 5"
                  width={800}
                  height={800}
                />
          ...
          <div className="col-span-2 md:col-span-1 row-span-2">
            <div className="group gallery-card h-full relative overflow-hidden rounded-xl shadow-lg transition-all duration-400 hover:shadow-2xl transform hover:-translate-y-1">
              <div className="aspect-[2/3] h-full w-full overflow-hidden">
                <Image
                  className="h-full w-full object-cover transition-transform duration-400 ease-in-out group-hover:scale-110"
                  src="/images/avatar/gallery-2/avatar-6.png"
                  alt="AI Avatar 6"
                  width={800}
                  height={1200}
                />
          ...
          <div className="col-span-1 row-span-1">
            <div className="group gallery-card h-full relative overflow-hidden rounded-xl shadow-lg transition-all duration-400 hover:shadow-2xl transform hover:-translate-y-1">
              <div className="aspect-square h-full w-full overflow-hidden">
                <Image
                  className="h-full w-full object-cover transition-transform duration-400 ease-in-out group-hover:scale-110"
                  src="/images/avatar/gallery-2/avatar-7.png"
                  alt="AI Avatar 7"
                  width={800}
                  height={800}
                />
          ...
          <div className="col-span-2 row-span-1">
            <div className="group gallery-card h-full relative overflow-hidden rounded-xl shadow-lg transition-all duration-400 hover:shadow-2xl transform hover:-translate-y-1">
              <div className="aspect-[16/9] h-full w-full overflow-hidden">
                <Image
                  className="h-full w-full object-cover transition-transform duration-400 ease-in-out group-hover:scale-110"
                  src="/images/avatar/gallery-2/avatar-8.png"
                  alt="AI Avatar 8"
                  width={1024}
                  height={576}
                />
          ...
          <div className="col-span-1 row-span-1">
            <div className="group gallery-card h-full relative overflow-hidden rounded-xl shadow-lg transition-all duration-400 hover:shadow-2xl transform hover:-translate-y-1">
              <div className="aspect-[3/4] h-full w-full overflow-hidden">
                <Image
                  className="h-full w-full object-cover transition-transform duration-400 ease-in-out group-hover:scale-110"
                  src="/images/avatar/gallery-2/avatar-9.png"
                  alt="AI Avatar 9"
                  width={768}
                  height={1024}
                />
          ...
          <div className="col-span-2 md:col-span-1 row-span-2">
            <div className="group gallery-card h-full relative overflow-hidden rounded-xl shadow-lg transition-all duration-400 hover:shadow-2xl transform hover:-translate-y-1">
              <div className="aspect-[9/16] h-full w-full overflow-hidden">
                <Image
                  className="h-full w-full object-cover transition-transform duration-400 ease-in-out group-hover:scale-110"
                  src="/images/avatar/gallery-2/avatar-10.png"
                  alt="AI Avatar 10"
                  width={576}
                  height={1024}
                />
          ...
          <div className="col-span-1 row-span-1">
            <div className="group gallery-card h-full relative overflow-hidden rounded-xl shadow-lg transition-all duration-400 hover:shadow-2xl transform hover:-translate-y-1">
              <div className="aspect-square h-full w-full overflow-hidden">
                <Image
                  className="h-full w-full object-cover transition-transform duration-400 ease-in-out group-hover:scale-110"
                  src="/images/avatar/gallery-2/avatar-11.png"
                  alt="AI Avatar 11"
                  width={800}
                  height={800}
                />
          ...
          <div className="col-span-2 md:col-span-1 row-span-2">
            <div className="group gallery-card h-full relative overflow-hidden rounded-xl shadow-lg transition-all duration-400 hover:shadow-2xl transform hover:-translate-y-1">
              <div className="aspect-[9/16] h-full w-full overflow-hidden">
                <Image
                  className="h-full w-full object-cover transition-transform duration-400 ease-in-out group-hover:scale-110"
                  src="/images/avatar/gallery-2/avatar-12.png"
                  alt="AI Avatar 12"
                  width={576}
                  height={1024}
                />
